...
from gateway.ssetting import SSetting
from gateway.saction import SAction
...
class SensorLogic:
    ...
    @staticmethod
    def begin_update(sensor, data):
        pass

    @staticmethod
    def end_update(sensor, properties):
        pass
